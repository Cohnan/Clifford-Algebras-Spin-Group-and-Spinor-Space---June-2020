...
\begin{frame}{Representation of $\cclv$ in \fjv} % % % % % % % % % % % % % % % % % % %
    ...
    \defn{The Clifford action} of $\cclv$ on the Fock space is extended to $\cclv$ by the action of $v \in V$, which is defined by:
...
\begin{frame}{Fock Space: odd dimension} % % % % % % % % % % % % % % % % % % %
    ...
    Let $U = span_\RR\set{e_1, \dots, e_{2m}} \subset V$. \defn{The Fock space} will be a fock space $\mathcal F_J(U)$.
